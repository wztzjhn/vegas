# vegas
A c++ (-std=c++17), **thread-safe**, **header-only** numerical integration routine with importance & stratified samplings [1].
...
## Refs
[1] G. P. Lepage, A new algorithm for adaptive multidimensional integration, J. Comp. Phys. 27, 192 (1978).
